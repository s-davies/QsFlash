...
class Recent extends React.Component {
  ...
  sortDecks() {
    let sortedDecks = Object.assign([], this.props.decks.map(deck => Object.assign({}, deck)));
    for (let i = 0; i < sortedDecks.length; i++) {
      ...
      if (i === sortedDecks.length - 1) {
        ...
        this.props.fetchDeckStudy(deck.id).then(() => deck.deckStudyUpdatedAt = this.props.deckStudy.updatedAt)
      }
    }
    // debugger
    // sortedDecks.sort((deck1, deck2) => {
